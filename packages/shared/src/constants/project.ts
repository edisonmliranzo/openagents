...
> = {
  windows: {
    ...
    runtimeNote: 'PowerShell with Node.js 20+, pnpm 9+, and Docker Desktop.',
  },
  macos: {
    label: 'macOS',
    shellPrefix: '$',
    ...
    runtimeNote: 'Homebrew with Node.js 20+, pnpm 9+, and Docker Desktop.',
  },
  ubuntu: {
    label: 'Ubuntu',
    shellPrefix: '$',
    ...
    runtimeNote: 'Ubuntu 22.04+ with Node.js 20+, pnpm 9+, and Docker Engine.',
  },
}
